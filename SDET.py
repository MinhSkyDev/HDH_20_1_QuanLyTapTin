...
class SDET:
    def __init__(self, data):
        # Khoi tao SDET tu 1 mang 1 chieu (goi tu phuong thuc FAT32.getSDETOfFolder())
        Entry = []
        start = 64
        end = 96
        while True:
    ...
    def readSubEntry(self, data):
        ...
        # 28d => lấy 4
        name1 = self.convertHexStringToASCIIString((data[1:11]))
        name2 = self.convertHexStringToASCIIString((data[14:26]))
        name3 = self.convertHexStringToASCIIString((data[28:32]))
    ...
    def readMainEntry(self, data):
        ...
        mainName = self.convertHexStringToASCIIString(data[0:8])

        wideName = self.convertHexStringToASCIIString(data[8:11])
    ...
    def readAllEntry(self):
        self.data = self.devideEntry(self.data)
    ...
    def convertHexStringToASCIIString(self, hexArray):
        ASCII_String = ""
        for i in hexArray:
            if i == "00":
                continue
